...
class M2DA_agent(nn.Module):
    ...
    def forward_features(
        ...
        return features, features_lidar, features_img
    ...
    def forward(self, x):
        ...
        features, features_lidar, features_img = self.forward_features(
            front_image,
            left_image,
            right_image,
            front_center_image,
        ...
        memory = self.encoder(features_fusioned, mask=self.attn_mask)
